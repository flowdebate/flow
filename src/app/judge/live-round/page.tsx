        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-amber-600 hover:bg-amber-700 text-white font-medium rounded-xl"
            >
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
              ...
              {isExpanded && (
                <div className="px-4 py-3 border-t border-slate-100 space-y-2">
                  {entry.arguments.map((arg) => (
                    <div
                      key={arg.id}
                      className="flex gap-2 items-start p-2 rounded-lg hover:bg-slate-50"
                    >
                      <select
                        value={arg.status}
                        onChange={(e) =>
                      ...
                      <div className="flex-1 space-y-1">
                        <input
                          ...
                          className="w-full text-sm font-medium text-slate-900 bg-transparent border-0 focus:outline-none placeholder:text-slate-300 px-0"
                        />
                        <textarea
                          value={arg.notes}
                          onChange={(e) =>
                          ...
                          placeholder="Notes..."
                          rows={1}
                          className="w-full text-xs text-slate-600 bg-transparent border-0 focus:outline-none placeholder:text-slate-300 resize-none px-0"
                        />
                      </div>
                      <button
                        onClick={() => removeArgument(entry.id, arg.id)}
                        className="flex-shrink-0 p-1 rounded hover:bg-red-50 text-slate-300 hover:text-red-500"
                      >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-medium text-slate-500 hover:bg-slate-100 hover:text-slate-700 w-full"
                  >
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          ...
          <textarea
            ...
            rows={4}
            className="w-full text-sm border border-slate-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent placeholder:text-slate-400 resize-none"
          />
        </div>
      </div>
    </div>
