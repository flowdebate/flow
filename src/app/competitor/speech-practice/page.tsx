        ...
        {!hasSubmitted ? (
                  ...
                  {speechTypes.map((type) => (
                    <button
                      ...
                      className={`px-3 py-2 rounded-xl text-sm font-medium border ${
                        speechType === type.id
                          ? "border-teal-600/30 bg-teal-600/10 text-teal-400"
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="text-sm text-teal-400 hover:text-teal-500 font-medium"
            >
            ...
            <div className="rounded-2xl border border-slate-700/50 bg-slate-800/50 p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="font-bold text-slate-100">Overall Evaluation</h2>
                <div className="flex items-center gap-2">
                    ...
                    >
                      <div
                        className={`flex-shrink-0 w-7 h-7 rounded-lg flex items-center justify-center ${
                          msg.role === "user" ? "bg-teal-600" : "bg-teal-500/10"
                        }`}
                      >
                        {msg.role === "user" ? (
...
function MetricSection({
  ...
  return (
    <div
      className="animate-fade-in rounded-2xl border border-slate-700/50 bg-slate-800/50 overflow-hidden"
